...
namespace StopWatch
{
    ...
    internal partial class SettingsForm : Form
    {
        ...
        public SettingsForm(Settings settings)
        {
            ...
            {
                new { Text = "Resetar todos os timers ao fechar", Value = SaveTimerSetting.NoSave },
                new { Text = "Salvar o tempo atual e pausar os timers ativos", Value = SaveTimerSetting.SavePause },
                new { Text = "Salvar o tempo atual e continuar os timers ativos", Value = SaveTimerSetting.SaveRunActive }
            };
            ...
            {
                new { Text = "Não pausar", Value = PauseAndResumeSetting.NoPause },
                new { Text = "Pausar o timer ativo", Value = PauseAndResumeSetting.Pause },
                new { Text = "Pausar e resumir ao desbloquear", Value = PauseAndResumeSetting.PauseAndResume }
            };
            ...
            {
                new { Text = "Postar como parte do log de trabalho", Value = WorklogCommentSetting.WorklogOnly },
                new { Text = "Postar apenas como comentário", Value = WorklogCommentSetting.CommentOnly },
                new { Text = "Postar como log de trabalho e comentário", Value = WorklogCommentSetting.WorklogAndComment }
            };
