...
namespace StopWatch
{
    internal class IssueControl : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ttIssue.SetToolTip(this.btnRemoveIssue, "Remover timer (CTRL-DEL)");
            ...
            this.ttIssue.SetToolTip(this.btnPostAndReset, "Enviar log de trabalho ao JIRA e resetar timer (CTRL-L)");
            ...
            this.ttIssue.SetToolTip(this.btnReset, "Resetar timer (CTRL-R)");
            ...
            this.ttIssue.SetToolTip(this.btnStartStop, "Iniciar/Pausar timer (CTRL-P)");
            ...
            this.ttIssue.SetToolTip(this.btnOpen, "Abrir tarefa no navegador(CTRL-O)");
