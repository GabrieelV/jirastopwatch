...
namespace StopWatch
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ttMain.SetToolTip(this.pbSettings, "Configurações");
            ...
            this.lblActiveFilter.Text = "Filtro";
            // 
            // notifyIcon
            // 
            ...
            this.ttMain.SetToolTip(this.pbAddIssue, "Adicionar nova linha de timer (CTRL-N)");
            ...
            this.ttMain.SetToolTip(this.pbHelp, "Abrir a página de ajuda");
